...
### Before usage
When dealing with v1.0 3d tiles, **you will need to convert the b3dm files in the tileset to glb** [use this tool](https://github.com/ebeaufay/B3DMExtractor), and you'll have to replace all refereences of b3dm in the tileset.json files (and any other nested json files) to glb.
